...
namespace pattern {
    ...
    namespace client {
        inline constexpr std::string_view ActionAbandonOngoingMatch = "40 57 48 83 EC 50 33 FF F6 05 C1 80 4D 01 01 0F";
        ...
        inline constexpr std::string_view ActionReconnectToOngoingMatch = "48 83 EC 38 F6 05 85 71 4D 01 01 74 5F 48 8B 0D";
        ...
        inline constexpr std::string_view CAttributeStringInit = "48 8B C2 48 83 C8 02 45 84 C0 48 0F 44 C2 48 89 41 08 48 8D 05 27 1D 44";
        ...
        inline constexpr std::string_view C_BaseEntity_StartParticleSystem = "48 89 5C 24 08 55 48 8B EC 48 83 EC 40 E8 8E 7C";
        ...
        inline constexpr std::string_view C_CSWeaponBaseGun_GetSpread = "48 83 EC 38 48 63 91 D8 17 00 00 48 8B 81 88 03";
        inline constexpr std::string_view C_CSWeaponBase_GetEconWpnData = "40 53 48 83 EC 40 48 8B D9 E8 ? ? ? ? 48 8B C8 E8 9A 65";
        ...
        inline constexpr std::string_view C_EconItemView_GetStaticData = "40 56 48 83 EC 20 48 89 5C 24 30 48 8B F1 48 8B 1D 3B 6A 34";
        inline constexpr std::string_view CacheParticleEffect = "4C 8B DC 53 48 81 EC 90 00 00 00 F2 0F 10 05 8D";
        ...
        inline constexpr std::string_view CalcWorldSpaceBones = "48 89 4C 24 08 55 53 56 57 41 54 41 55 41 56 41 57 B8 88 42";
        inline constexpr std::string_view CalculateInterpolation = "48 83 EC 08 4C 8B 0D ? ? ? ? 4C 8B DA 48 8B";
        inline constexpr std::string_view CalculateWorldSpaceBones = "48 89 4C 24 08 55 53 56 57 41 54 41 55 41 56 41 57 B8 88 42";
        inline constexpr std::string_view ChangeModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D DD";
        ...
        inline constexpr std::string_view ConvarGet = "FF 24 00 CC 4C 8B 49 08 49 8B 49 30 4D 8D 41 58";
        ...
        inline constexpr std::string_view CreateEntityByClassName = "4C 8D 05 ? ? ? ? 4C 8B CF BA 03 00 00 00 FF 15 25 EA 30";
        ...
        inline constexpr std::string_view CreateNewSubtickMoveStep = "48 89 5C 24 10 57 48 83 EC 20 33 DB 48 8B F9 48 85 C9 75 2D B9 38 00 00 00 E8 62 BF";
        ...
        inline constexpr std::string_view CreateSubtickMoveStep = "48 89 5C 24 10 57 48 83 EC 20 33 DB 48 8B F9 48 85 C9 75 2D B9 38 00 00 00 E8 62 BF";
        ...
        inline constexpr std::string_view DispatchEffect = "48 89 5C 24 08 57 48 83 EC 40 48 8B F9 48 8B DA";
        ...
        inline constexpr std::string_view DrawCrosshair = "48 89 5C 24 08 57 48 83 EC 20 48 8B D9 E8 5E 40";
        ...
        inline constexpr std::string_view DrawSmokeArray = "48 89 54 24 10 55 41 54 48 8D AC 24 38 F9 FF FF";
        ...
        inline constexpr std::string_view EmitPanoramaSound = "40 53 48 81 EC B0 00 00 00 0F 10 02 48 8B 05 B5";
        ...
        inline constexpr std::string_view FX_FireBullets = "48 8B C4 4C 89 48 20 48 89 50 10 55 53 57 41 54 41 55 48 8D A8 58 FB FF";
        inline constexpr std::string_view FindHudElement = "48 8D 15 ? ? ? ? 45 33 C0 B9 01 00 00 00 FF 15 32 39 B6";
        ...
        inline constexpr std::string_view GameTraceLine = "4C 8B DC 49 89 5B 08 49 89 6B 10 49 89 73 18 57 48 81 EC 80 00 00 00 33";
        ...
        inline constexpr std::string_view GetAbsOrigin = "40 53 48 83 EC 20 48 8B 99 30 03 00 00 90 80 BB 10 01 00 00 00 74 08 48 8B CB E8 C1";
        ...
        inline constexpr std::string_view GetBombsiteBCenter = "48 89 5C 24 08 57 48 83 EC 20 48 8B F9 48 8B DA 48 8B 0D ? ? ? ? 48 85 C9 74 19 E8 1F B0 EA";
        ...
        inline constexpr std::string_view GetCustomPaintKitIndex = "48 89 5C 24 08 57 48 83 EC 40 8B 15 ? ? ? ? 48 8B F9 65 48 8B 04 25 58 00 00 00 B9 68 00 00 00 48 8B 04 D0 8B 04 01 39 05 22 A2 34 01 0F 8F";
        inline constexpr std::string_view GetDirectChallengeCode = "48 83 EC 28 F7 05 F2 32 1B 01 FF FF FF 3F 75 05";
        ...
        inline constexpr std::string_view GetLocalControllerById = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 10 03 00 00 8B 08 48 63 C1 4C 8D 05 E6 63";
        inline constexpr std::string_view GetLocalPawn = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 10 03 00 00 8B 08 48 63 C1 4C 8D 05 E6 63";
        inline constexpr std::string_view GetLocalPlayerController = "48 83 EC 28 83 F9 FF 75 17 48 8B 0D ? ? ? ? 48 8D 54 24 30 48 8B 01 FF 90 10 03 00 00 8B 08 48 63 C1 48 8D 0D 26 64";
        ...
        inline constexpr std::string_view GetPlayerModel = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B CA FF 15 80 DF A3 00";
        ...
        inline constexpr std::string_view GetRemovedAimPunch_E8 = "40 53 48 83 EC 20 48 8B 89 B8 14 00 00 48 8B DA";
        inline constexpr std::string_view GetRemovedAimpunch = "F2 0F 10 44 24 60 F2 0F 11 84 24 88 00 00 00 FF 15 24 32 86";
        inline constexpr std::string_view GetRotatingOfficialMapGroupCurrentState = "48 81 EC 38 04 00 00 48 8B CA 48 8D 15 AF 94 B3";
        inline constexpr std::string_view GetServerName = "40 53 48 83 EC 20 48 8B D9 48 8B 0D ? ? ? ? 48 85 C9 74 35 E8 36 4D";
        ...
        inline constexpr std::string_view GetTournamentStageNameByIndex = "40 53 48 83 EC 20 8B 05 ? ? ? ? C1 E8 ? ? ? ? A8 01 74 79 48 8B 05 EB D6 49";
        ...
        inline constexpr std::string_view GetTournamentTeamNameByIndex = "40 53 48 83 EC 20 8B 05 ? ? ? ? C1 E8 ? ? ? ? A8 01 74 79 48 8B 05 8B D3 49";
        ...
        inline constexpr std::string_view GetUserCmdManager = "41 56 41 57 48 83 EC 48 48 8D 54 24 68 E8 CE 3C";
        ...
        inline constexpr std::string_view GetWeaponInAccuracyRecoveryTime = "48 89 5C 24 08 57 48 83 EC 30 48 8B D9 E8 1E FE";
        ...
        inline constexpr std::string_view HasOngoingMatch = "0F B6 05 79 B8 49 01 24 01 C3 CC CC CC CC CC CC";
        ...
        inline constexpr std::string_view InfoForResourceTypeCCompositeMaterial_TypeManager = "40 55 41 56 48 83 EC 68 48 8B EA 83 F9 06 0F 87 ? ? ? ? 48 63 C1 48 8D 15 A2 4B";
        ...
        inline constexpr std::string_view InitTraceInfo = "40 55 41 55 41 57 48 83 EC 30 4C 8B 3D 87 E0 F2";
        ...
        inline constexpr std::string_view IsLocalPlayerWatchingOwnDemo = "48 89 5C 24 08 48 89 6C 24 18 48 89 74 24 20 57 48 83 EC 20 48 8B 0D F5";
        ...
        inline constexpr std::string_view LevelShutdown = "48 83 EC 28 48 8B 0D ? ? ? ? 48 8D 15 76 79";
        ...
        inline constexpr std::string_view MarkInterpLatchFlagsDirty = "40 53 56 57 48 83 EC 40 80 3D 8D 55 19 02 00 8B";
        inline constexpr std::string_view MatchFoundHandler = "48 85 D2 0F 84 ? ? ? ? 48 8B C4 55 53 56 57";
        inline constexpr std::string_view ModernSubtickJumpCheck = "48 89 5C 24 10 48 89 6C 24 18 57 48 83 EC 40 48 8B EA 48 8B";
        inline constexpr std::string_view ModulationUpdate = "48 89 5C 24 08 57 48 83 EC 20 8B FA 48 8B D9 E8 ? ? ? ? 84 C0 0F 84";
        inline constexpr std::string_view MovementServices_CheckJumpButton = "4C 89 44 24 18 55 56 41 56 48 8D AC 24 80 EC FF";
        inline constexpr std::string_view NoClipOnChange = "48 89 5C 24 10 48 89 74 24 18 48 89 7C 24 20 55 48 8B EC 48 83 EC 30 48 8D 05 8A F8";
        ...
        inline constexpr std::string_view OnGlowTypeChanged = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B 05 CA F5";
        ...
        inline constexpr std::string_view ParticleCollection = "48 89 5C 24 08 57 48 83 EC 20 0F 28 05 BF 6E 37";
        ...
        inline constexpr std::string_view PostProcessQuery = "48 89 5C 24 08 66 41 0F 6E C8 48 8D 1D 6F 9E F4";
        ...
        inline constexpr std::string_view QueueForceSubtickMove = "48 83 EC 28 8B 0D ? ? ? ? 65 48 8B 04 25 58 00 00 00 BA 68 00 00 00 48 8B 04 C8 8B 04 02 39 05 DB 5C 99 01 0F 8F 82";
        ...
        inline constexpr std::string_view RemoveLegs = "40 55 53 56 41 56 41 57 48 8D AC 24 A0 FB FF FF";
        inline constexpr std::string_view RenderDecals = "44 88 4C 24 20 48 89 54 24 10 55 53 57 41 54 41";
        ...
        inline constexpr std::string_view ReportHit = "40 53 48 83 EC 20 48 8D 05 ? ? ? ? 48 8D 59 08 48 89 01 F6 03 01 74 08 48 8B CB E8 4F 00 E8";
        inline constexpr std::string_view RunCommand_Context = "48 8B C4 48 81 EC C8 00 00 00 48 89 58 10 48 89";
        inline constexpr std::string_view SOCreated = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 30 48 8B FA 48 8B F1 41 83 F9 01 75 7F 48 8B 5C 24 60 48 85 DB 74 75 48 85 D2 74 70 49 8B C8 E8 BE 4B";
        inline constexpr std::string_view ScreenTransform = "48 89 74 24 10 57 48 83 EC 30 48 83 3D FE 41 67";
        ...
        inline constexpr std::string_view SetDynamicAttributeValue = "48 89 6C 24 20 57 41 56 41 57 48 81 EC A0 00 00 00 48 8B FA C7 44 24 20 00 00 00 00 4D 8B F8 4C 8D 0D ? ? ? ? 48 8B E9 ? ? ? ? 66 12 01";
        inline constexpr std::string_view SetDynamicAttributeValue_raw = "48 89 6C 24 20 57 41 56 41 57 48 81 EC A0 00 00 00 48 8B FA C7 44 24 20 00 00 00 00 4D 8B F8 4C 8D 0D ? ? ? ? 48 8B E9 ? ? ? ? 66 12 01";
        ...
        inline constexpr std::string_view SetModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D DD";
        ...
        inline constexpr std::string_view SetupMapInfo = "48 8B C4 48 89 58 10 48 89 68 18 48 89 70 20 57 48 81 EC A0 00 00 00 0F";
        ...
        inline constexpr std::string_view ShouldShowHudElements = "48 83 EC 28 BA FF FF FF FF 48 8D 0D ? ? ? ? E8 CB 69 90";
        ...
        inline constexpr std::string_view Spawner_PerTickOrchestrator = "48 8B C4 55 53 48 8D A8 E8 ? ? ? ? 81 EC 08 03 00 00 80";
        ...
        inline constexpr std::string_view TakeDamageOld = "40 55 53 56 57 41 54 48 8D 6C 24 C0 48 81 EC 40";
        inline constexpr std::string_view TestSurfaces = "40 53 57 41 56 48 83 EC 50 8B 84 24 90 00 00 00";
        inline constexpr std::string_view ThinkReturn = "BA 04 00 00 00 FF 15 3E B1 63 01 84 C0 0F 84 C2";
        ...
        inline constexpr std::string_view TraceInitInfo = "40 55 41 55 41 57 48 83 EC 30 4C 8B 3D 87 E0 F2";
        inline constexpr std::string_view TracePlayerBBox = "48 89 5C 24 18 55 57 41 54 41 55 41 56 48 83 EC";
        inline constexpr std::string_view TraceShape = "48 89 54 24 10 48 89 4C 24 08 55 53 56 57 41 56 41 57 48 8D AC 24 18 DC";
        inline constexpr std::string_view TraceShape_Client = "48 89 54 24 10 48 89 4C 24 08 55 53 56 57 41 56 41 57 48 8D AC 24 18 DC";
        ...
        inline constexpr std::string_view UntrustedFlagSetter = "74 26 C6 05 9A A6 09 02 01 33 C0 83 F8 01 74 18";
        inline constexpr std::string_view Update = "48 8B C4 89 50 10 48 89 48 08 55 53 57 41 56 48";
        ...
        inline constexpr std::string_view UpdateSkybox = "48 89 5C 24 08 57 48 83 EC 30 48 8B F9 E8 5E 44";
        inline constexpr std::string_view UpdateSubClass = "4C 8B DC 53 48 81 EC 90 01 00 00 48 8B 41 10 48";
        inline constexpr std::string_view UpdateTurningInAccuracy = "40 56 48 81 EC 80 00 00 00 48 8B F1 BA FF FF FF FF 48 8D 0D ? ? ? ? E8 13 C4 07";
        inline constexpr std::string_view ValidateDirectChallengeCode = "40 53 41 56 48 83 EC 38 4D 8B F0 48 8B DA 48 85";
        inline constexpr std::string_view ViewModelHideZoomed = "40 55 53 56 57 48 8B EC 48 83 EC 58 48 8D 05 DD";
        ...
        inline constexpr std::string_view pMainMenuPanel = "EC ? 48 8B 05 ? ? ? ? 48 8D 15 ? ? ? ? 48";
        inline constexpr std::string_view pParticleManager = "48 8B 0D ? ? ? ? 41 B8 ? ? ? ? F3 0F 11 74 24 ? 48 C7 44 24 ? ? ? ? ?";
        inline constexpr std::string_view pPlantedC4s = "0F 85 ? ? ? ? 39 3D ? ? ? ? 7E ? 49 8B 0E 48 8B 1D ? ? ? ? 48 8B D3 4C 8B 81 48 01 00 00";
        inline constexpr std::string_view pPrediction = "48 8D 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 40 53 56 41 54";
        inline constexpr std::string_view pSensitivity = "48 8D 0D ? ? ? ? 66 0F 6E CD";
        inline constexpr std::string_view pUiEngine = "48 89 78 ? 48 89 0D ? ? ? ?";
        inline constexpr std::string_view pVPhys2World = "4C 8B 25 ? ? ? ? 24";
    ...
    namespace engine2 {
        ...
        inline constexpr std::string_view ForceDemoRecordingFullUpdateAfterNextDeltaPacket = "48 89 5C 24 08 48 89 74 24 10 57 48 83 EC 20 48 8B 1D 4A 49";
        ...
        inline constexpr std::string_view GetScreenAspectRatio = "48 89 5C 24 08 57 48 83 EC 20 8B FA 48 8D 0D AD";
        ...
        inline constexpr std::string_view ProcessServerInfo = "48 89 5C 24 08 57 48 83 EC 30 48 8B FA 48 8B D9";
        ...
        inline constexpr std::string_view SendMovePacket = "40 55 57 41 57 48 8D 6C 24 F0 48 81 EC 10 01 00 00 4C 8B F9";
        inline constexpr std::string_view SendSnapshot = "48 89 54 24 10 48 89 4C 24 08 55 53 56 57 41 56";
        inline constexpr std::string_view SetSignonState = "40 55 53 41 55 41 56 41 57 48 8D 6C 24 C9 48 81";
    ...
    namespace materialsystem2 {
        ...
        inline constexpr std::string_view LoadShadersAndSetupModes = "44 89 44 24 18 48 89 54 24 10 53 55 56 41 55 48";
    ...
    namespace networksystem {
        ...
        inline constexpr std::string_view pNetworkSystem = "48 8D 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 48 83 EC 28 BA FF FF FF";
    }
    namespace panorama {
    ...
    namespace particles {
        ...
        inline constexpr std::string_view GetParticleManager = "48 8B 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 40 55 41 56 41 57 48 8B EC 48 83 EC ?";
    ...
    namespace scenesystem {
        ...
        inline constexpr std::string_view DrawAggregateSceneObjectArray = "48 8B C4 48 89 50 10 48 89 48 08 55 53 56 57 41 54 41 55 41 56 41 57 48 8D A8 D8 F8";
        ...
        inline constexpr std::string_view GeneratePrimitives = "48 8B C4 4C 89 48 20 4C 89 40 18 48 89 50 10 48 89 48 08 55 53 56 57 41 54 41 55 41 56 41 57 48 8D A8 B8 FE FF FF 48 81";
        ...
        inline constexpr std::string_view SceneSystem_Thread_RenderSceneDrawList = "48 89 5C 24 08 48 89 74 24 18 48 89 7C 24 20 55 41 54 41 55 41 56 41 57 48 8D 6C 24";
        ...
        inline constexpr std::string_view pSceneSystem = "48 8D 05 ? ? ? ? C3 CC CC CC CC CC CC CC CC 48 8D 0D ? ? ? ? E9";
    }
    namespace schemasystem {
        inline constexpr std::string_view InstallSchemaBindings = "40 53 48 83 EC 20 48 8B DA 48 8B D1 48 8D 0D 4D";
    ...
    namespace server {
        inline constexpr std::string_view AcceptInput = "48 89 5C 24 18 48 89 54 24 10 48 89 4C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 80 48";
        inline constexpr std::string_view AddEntityIOEvent = "48 89 5C 24 18 4C 89 4C 24 20 48 89 4C 24 08 55 56 57 41 54 41 55 41 56 41 57 48 83 EC 20 49 8B";
        ...
        inline constexpr std::string_view CreateEntityByName = "48 83 EC 48 C6 44 24 30 00 4C 8B C1 48 8B 0D AD";
        ...
        inline constexpr std::string_view GameSystem_Think_CheckSteamBan = "41 54 48 81 EC 90 00 00 00 BA FF FF FF FF 48 8D";
        ...
        inline constexpr std::string_view LoopPostInitAllSystems_pEventDispatcher = "48 39 1D 78 69 94 01 74 4D 39 05 D0 68 94 01 7E";
        inline constexpr std::string_view NetworkStateChanged = "4C 8B C2 48 8B D1 48 8B 09 48 85 C9 74 35 48 8B";
        inline constexpr std::string_view PostThink = "40 57 48 81 EC 50 01 00 00 80 3D 3C EB D2 01 00";
        inline constexpr std::string_view ProcessUsercmds = "48 8B C4 44 88 48 20 44 89 40 18 48 89 50 10 53";
        inline constexpr std::string_view RemovePlayerItem = "48 85 D2 0F 84 ? ? ? ? 48 89 5C 24 08 57 48 83 EC 30 48 8B DA 48 8B F9 E8 D2 74";
        ...
        inline constexpr std::string_view SetModel = "40 53 48 83 EC 20 48 8B D9 4C 8B C2 48 8B 0D 7D";
        ...
        inline constexpr std::string_view TerminateRound = "48 8B C4 4C 89 48 20 48 89 48 08 55 41 54 41 56";
        inline constexpr std::string_view Think = "40 55 53 41 55 41 57 48 8D 6C 24 C1 48 81 EC A8";
        inline constexpr std::string_view TriggerPush_Touch = "48 89 5C 24 08 48 89 7C 24 10 55 48 8D 6C 24 D0";
        ...
        inline constexpr std::string_view UTIL_CreateEntityByName = "48 83 EC 48 C6 44 24 30 00 4C 8B C1 48 8B 0D AD";
    ...
    namespace soundsystem {
        ...
        inline constexpr std::string_view pSoundChannels = "8B 3D ? ? ? ? 48 89 58";
    ...
    namespace tier0 {
        ...
        inline constexpr std::string_view LoadKeyValues = "48 89 5C 24 10 48 89 6C 24 18 48 89 7C 24 20 41 54 41 56 41 57 48 83 EC 50 45 33 E4";
        inline constexpr std::string_view Plat_FloatTime = "48 83 EC 28 48 83 3D EC 8C 28 00 00 75 05 E8 5D";
