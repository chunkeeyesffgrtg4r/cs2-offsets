...
namespace vphysics2 {
    ...
    public:
        ...
        SCHEMA_FIELD(CUtlVector<FeSimdRodConstraint_t>, m_SimdRods                                      , 0xF0) // CUtlVector<FeSimdRodConstraint_t>
        SCHEMA_FIELD(CUtlVector<FeSimdRodConstraintAnim_t>, m_SimdRodsAnim                                  , 0x108) // CUtlVector<FeSimdRodConstraintAnim_t>
        SCHEMA_FIELD(CUtlVector<CTransform>          , m_InitPose                                      , 0x120) // CUtlVector<CTransform>
        SCHEMA_FIELD(CUtlVector<FeRodConstraint_t>   , m_Rods                                          , 0x138) // CUtlVector<FeRodConstraint_t>
        SCHEMA_FIELD(CUtlVector<FeTwistConstraint_t> , m_Twists                                        , 0x150) // CUtlVector<FeTwistConstraint_t>
        SCHEMA_FIELD(CUtlVector<FeHingeLimit_t>      , m_HingeLimits                                   , 0x168) // CUtlVector<FeHingeLimit_t>
        SCHEMA_FIELD(CUtlVector<uint32>              , m_AntiTunnelBytecode                            , 0x180) // CUtlVector<uint32>
        SCHEMA_FIELD(CUtlVector<FeDynKinLink_t>      , m_DynKinLinks                                   , 0x198) // CUtlVector<FeDynKinLink_t>
        SCHEMA_FIELD(CUtlVector<FeBoneMergeLink_t>   , m_BoneMergeLinks                                , 0x1B0) // CUtlVector<FeBoneMergeLink_t>
        SCHEMA_FIELD(CUtlVector<FeAntiTunnelProbe_t> , m_AntiTunnelProbes                              , 0x1C8) // CUtlVector<FeAntiTunnelProbe_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_AntiTunnelTargetNodes                         , 0x1E0) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<FeNodeStrayBox_t>    , m_NodeStrayBoxes                                , 0x1F8) // CUtlVector<FeNodeStrayBox_t>
        SCHEMA_FIELD(CUtlVector<FeAxialEdgeBend_t>   , m_AxialEdges                                    , 0x210) // CUtlVector<FeAxialEdgeBend_t>
        SCHEMA_FIELD(CUtlVector<float32>             , m_NodeInvMasses                                 , 0x228) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<FeCtrlOffset_t>      , m_CtrlOffsets                                   , 0x240) // CUtlVector<FeCtrlOffset_t>
        SCHEMA_FIELD(CUtlVector<FeCtrlOsOffset_t>    , m_CtrlOsOffsets                                 , 0x258) // CUtlVector<FeCtrlOsOffset_t>
        SCHEMA_FIELD(CUtlVector<FeFollowNode_t>      , m_FollowNodes                                   , 0x270) // CUtlVector<FeFollowNode_t>
        SCHEMA_FIELD(CUtlVector<FeCollisionPlane_t>  , m_CollisionPlanes                               , 0x288) // CUtlVector<FeCollisionPlane_t>
        SCHEMA_FIELD(CUtlVector<FeNodeIntegrator_t>  , m_NodeIntegrator                                , 0x2A0) // CUtlVector<FeNodeIntegrator_t>
        SCHEMA_FIELD(CUtlVector<FeSpringIntegrator_t>, m_SpringIntegrator                              , 0x2B8) // CUtlVector<FeSpringIntegrator_t>
        SCHEMA_FIELD(CUtlVector<FeSimdSpringIntegrator_t>, m_SimdSpringIntegrator                          , 0x2D0) // CUtlVector<FeSimdSpringIntegrator_t>
        SCHEMA_FIELD(CUtlVector<FeWorldCollisionParams_t>, m_WorldCollisionParams                          , 0x2E8) // CUtlVector<FeWorldCollisionParams_t>
        SCHEMA_FIELD(CUtlVector<float32>             , m_LegacyStretchForce                            , 0x300) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_NodeCollisionRadii                            , 0x318) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_DynNodeFriction                               , 0x330) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_LocalRotation                                 , 0x348) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<float32>             , m_LocalForce                                    , 0x360) // CUtlVector<float32>
        SCHEMA_FIELD(CUtlVector<FeTaperedCapsuleStretch_t>, m_TaperedCapsuleStretches                       , 0x378) // CUtlVector<FeTaperedCapsuleStretch_t>
        SCHEMA_FIELD(CUtlVector<FeTaperedCapsuleRigid_t>, m_TaperedCapsuleRigids                          , 0x390) // CUtlVector<FeTaperedCapsuleRigid_t>
        SCHEMA_FIELD(CUtlVector<FeSphereRigid_t>     , m_SphereRigids                                  , 0x3A8) // CUtlVector<FeSphereRigid_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_WorldCollisionNodes                           , 0x3C0) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_TreeParents                                   , 0x3D8) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_TreeCollisionMasks                            , 0x3F0) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<FeTreeChildren_t>    , m_TreeChildren                                  , 0x408) // CUtlVector<FeTreeChildren_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_FreeNodes                                     , 0x420) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<FeFitMatrix_t>       , m_FitMatrices                                   , 0x438) // CUtlVector<FeFitMatrix_t>
        SCHEMA_FIELD(CUtlVector<FeFitWeight_t>       , m_FitWeights                                    , 0x450) // CUtlVector<FeFitWeight_t>
        SCHEMA_FIELD(CUtlVector<FeNodeReverseOffset_t>, m_ReverseOffsets                                , 0x468) // CUtlVector<FeNodeReverseOffset_t>
        SCHEMA_FIELD(CUtlVector<FeAnimStrayRadius_t> , m_AnimStrayRadii                                , 0x480) // CUtlVector<FeAnimStrayRadius_t>
        SCHEMA_FIELD(CUtlVector<FeSimdAnimStrayRadius_t>, m_SimdAnimStrayRadii                            , 0x498) // CUtlVector<FeSimdAnimStrayRadius_t>
        SCHEMA_FIELD(CUtlVector<FeKelagerBend2_t>    , m_KelagerBends                                  , 0x4B0) // CUtlVector<FeKelagerBend2_t>
        SCHEMA_FIELD(CUtlVector<FeCtrlSoftOffset_t>  , m_CtrlSoftOffsets                               , 0x4C8) // CUtlVector<FeCtrlSoftOffset_t>
        SCHEMA_FIELD(CUtlVector<CFeIndexedJiggleBone>, m_JiggleBones                                   , 0x4E0) // CUtlVector<CFeIndexedJiggleBone>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_SourceElems                                   , 0x4F8) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<uint32>              , m_GoalDampedSpringIntegrators                   , 0x510) // CUtlVector<uint32>
        SCHEMA_FIELD(CUtlVector<FeTri_t>             , m_Tris                                          , 0x528) // CUtlVector<FeTri_t>
        SCHEMA_FIELD(std::uint16_t                   , m_nTriCount1                                    , 0x540) // uint16
        SCHEMA_FIELD(std::uint16_t                   , m_nTriCount2                                    , 0x542) // uint16
        SCHEMA_FIELD(std::uint8_t                    , m_nReservedUint8                                , 0x544) // uint8
        SCHEMA_FIELD(std::uint8_t                    , m_nExtraPressureIterations                      , 0x545) // uint8
        SCHEMA_FIELD(std::uint8_t                    , m_nExtraGoalIterations                          , 0x546) // uint8
        SCHEMA_FIELD(std::uint8_t                    , m_nExtraIterations                              , 0x547) // uint8
        SCHEMA_FIELD(CUtlVector<FeSDFRigid_t>        , m_SDFRigids                                     , 0x548) // CUtlVector<FeSDFRigid_t>
        SCHEMA_FIELD(CUtlVector<FeBoxRigid_t>        , m_BoxRigids                                     , 0x560) // CUtlVector<FeBoxRigid_t>
        SCHEMA_FIELD(CUtlVector<uint8>               , m_DynNodeVertexSet                              , 0x578) // CUtlVector<uint8>
        SCHEMA_FIELD(CUtlVector<uint32>              , m_VertexSetNames                                , 0x590) // CUtlVector<uint32>
        SCHEMA_FIELD(CUtlVector<FeRigidColliderIndices_t>, m_RigidColliderPriorities                       , 0x5A8) // CUtlVector<FeRigidColliderIndices_t>
        SCHEMA_FIELD(CUtlVector<FeMorphLayerDepr_t>  , m_MorphLayers                                   , 0x5C0) // CUtlVector<FeMorphLayerDepr_t>
        SCHEMA_FIELD(CUtlVector<uint8>               , m_MorphSetData                                  , 0x5D8) // CUtlVector<uint8>
        SCHEMA_FIELD(CUtlVector<FeVertexMapDesc_t>   , m_VertexMaps                                    , 0x5F0) // CUtlVector<FeVertexMapDesc_t>
        SCHEMA_FIELD(CUtlVector<uint8>               , m_VertexMapValues                               , 0x608) // CUtlVector<uint8>
        SCHEMA_FIELD(CUtlVector<FeEffectDesc_t>      , m_Effects                                       , 0x620) // CUtlVector<FeEffectDesc_t>
        SCHEMA_FIELD(CUtlVector<FeCtrlOffset_t>      , m_LockToParent                                  , 0x638) // CUtlVector<FeCtrlOffset_t>
        SCHEMA_FIELD(CUtlVector<uint16>              , m_LockToGoal                                    , 0x650) // CUtlVector<uint16>
        SCHEMA_FIELD(CUtlVector<int16>               , m_SkelParents                                   , 0x668) // CUtlVector<int16>
        SCHEMA_FIELD(CUtlVector<FeNodeWindBase_t>    , m_DynNodeWindBases                              , 0x680) // CUtlVector<FeNodeWindBase_t>
        SCHEMA_FIELD(CUtlVector<FeModelSelfCollisionLayer_t>, m_SelfCollisionLayers                           , 0x698) // CUtlVector<FeModelSelfCollisionLayer_t>
        SCHEMA_FIELD(float                           , m_flInternalPressure                            , 0x6B0) // float32
        SCHEMA_FIELD(float                           , m_flDefaultTimeDilation                         , 0x6B4) // float32
        SCHEMA_FIELD(float                           , m_flWindage                                     , 0x6B8) // float32
        SCHEMA_FIELD(float                           , m_flWindDrag                                    , 0x6BC) // float32
        SCHEMA_FIELD(float                           , m_flDefaultSurfaceStretch                       , 0x6C0) // float32
        SCHEMA_FIELD(float                           , m_flDefaultThreadStretch                        , 0x6C4) // float32
        SCHEMA_FIELD(float                           , m_flDefaultGravityScale                         , 0x6C8) // float32
        SCHEMA_FIELD(float                           , m_flDefaultVelAirDrag                           , 0x6CC) // float32
        SCHEMA_FIELD(float                           , m_flDefaultExpAirDrag                           , 0x6D0) // float32
        SCHEMA_FIELD(float                           , m_flDefaultVelQuadAirDrag                       , 0x6D4) // float32
        SCHEMA_FIELD(float                           , m_flDefaultExpQuadAirDrag                       , 0x6D8) // float32
        SCHEMA_FIELD(float                           , m_flRodVelocitySmoothRate                       , 0x6DC) // float32
        SCHEMA_FIELD(float                           , m_flQuadVelocitySmoothRate                      , 0x6E0) // float32
        SCHEMA_FIELD(float                           , m_flAddWorldCollisionRadius                     , 0x6E4) // float32
        SCHEMA_FIELD(float                           , m_flDefaultVolumetricSolveAmount                , 0x6E8) // float32
        SCHEMA_FIELD(float                           , m_flMotionSmoothCDT                             , 0x6EC) // float32
        SCHEMA_FIELD(float                           , m_flLocalDrag1                                  , 0x6F0) // float32
        SCHEMA_FIELD(std::uint16_t                   , m_nRodVelocitySmoothIterations                  , 0x6F4) // uint16
